...
{
    const XML_PATH_BOLETO_ACTIVE						= 'payment/boleto/active';
    const XML_PATH_BOLETO_TITLE							= 'payment/boleto/title';
    const XML_PATH_BOLETO_TEMPLATE_EMAIL_SEGUNDA_VIA	= 'payment/boleto/boleto_bancario_email_segunda_via';
    const XML_PATH_BOLETO_ORDER_STATUS					= 'payment/boleto/order_status';
    const XML_PATH_BOLETO_CUSTOM_TEXT					= 'payment/boleto/custom_text';
    const XML_PATH_BOLETO_BANCO							= 'payment/boleto/banco';
    const XML_PATH_BOLETO_PRAZO_PAGAMENTO				= 'payment/boleto/prazo_pagamento';
    const XML_PATH_BOLETO_TAXA_BOLETO					= 'payment/boleto/taxa_boleto';
    const XML_PATH_BOLETO_DEMONSTRATIVO1				= 'payment/boleto/demonstrativo1';
    const XML_PATH_BOLETO_DEMONSTRATIVO2				= 'payment/boleto/demonstrativo2';
    const XML_PATH_BOLETO_DEMONSTRATIVO3				= 'payment/boleto/demonstrativo3';
    const XML_PATH_BOLETO_INSTRUCOES1					= 'payment/boleto/instrucoes1';
    const XML_PATH_BOLETO_INSTRUCOES2					= 'payment/boleto/instrucoes2';
    const XML_PATH_BOLETO_INSTRUCOES3					= 'payment/boleto/instrucoes3';
    const XML_PATH_BOLETO_INSTRUCOES4					= 'payment/boleto/instrucoes4';
    const XML_PATH_BOLETO_SECANCELADO					= 'payment/boleto/secancelado';
    const XML_PATH_BOLETO_INICIO_NOSSO_NUMERO			= 'payment/boleto/inicio_nosso_numero';
    const XML_PATH_BOLETO_DIGITOS_NOSSO_NUMERO			= 'payment/boleto/digitos_nosso_numero';
    const XML_PATH_BOLETO_AGENCIA						= 'payment/boleto/agencia';
    const XML_PATH_BOLETO_AGENCIA_DV					= 'payment/boleto/agencia_dv';
    const XML_PATH_BOLETO_CONTA							= 'payment/boleto/conta';
    const XML_PATH_BOLETO_CONTA_DV						= 'payment/boleto/conta_dv';
    const XML_PATH_BOLETO_CONTA_CEDENTE					= 'payment/boleto/conta_cedente';
    const XML_PATH_BOLETO_CONTA_CEDENTE_DV				= 'payment/boleto/conta_cedente_dv';
    const XML_PATH_BOLETO_CEDENTE				        = 'payment/boleto/cedente';
    const XML_PATH_BOLETO_CARTEIRA						= 'payment/boleto/carteira';
    const XML_PATH_BOLETO_VARIACAO_CARTEIRA				= 'payment/boleto/variacao_carteira';
    const XML_PATH_BOLETO_ESPECIE						= 'payment/boleto/especie';
    const XML_PATH_BOLETO_CONTRATO						= 'payment/boleto/contrato';
    const XML_PATH_BOLETO_CONVENIO						= 'payment/boleto/convenio';
    const XML_PATH_BOLETO_IDENTIFICACAO					= 'payment/boleto/identificacao';
    const XML_PATH_BOLETO_CPF_CNPJ						= 'payment/boleto/cpf_cnpj';
    const XML_PATH_BOLETO_ENDERECO						= 'payment/boleto/endereco';
    const XML_PATH_BOLETO_CIDADE_UF						= 'payment/boleto/cidade_uf';
    const XML_PATH_BOLETO_PATH_LOGO						= 'payment/boleto/path_logo';
    const XML_PATH_BOLETO_ALLOWSPECIFIC					= 'payment/boleto/allowspecific';
    const XML_PATH_BOLETO_SPECIFICCOUNTRY				= 'payment/boleto/specificcountry';
